...
const hexToRgb = (hex) => {
  ...
  if (!result) return [0.608, 0.349, 0.714];
  return [
...
export const Plasma = ({
  ...
  useEffect(() => {
    ...
    const customColorRgb = color ? hexToRgb(color) : [0.608, 0.349, 0.714];
    ...
    const handleMouseMove = (e) => {
      ...
      // Suavizar movimiento del mouse con interpolación
    ...
    return () => {
      ...
      try {
        ...
        console.warn("Canvas cleanup: ", err.message);
      }
    };
